...
export default function FavoritesPage() {
  ...
  const favoriteProperties = allProperties.filter((p) => favorites.includes(String(p.id)));
  ...
  return (
    <main className="min-h-screen bg-page transition-colors">
      <section className="bg-[#eef2ff] dark:bg-surface/60 px-4 md:px-6 lg:px-8 py-16 text-center flex flex-col items-center gap-4 transition-colors">
        ...
        <p className="text-muted-foreground text-[16px]">Your saved properties</p>
      </section>
          ...
          <>
            ...
            {favoriteProperties.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-24 gap-4 text-center">
                ...
                <h2 className="text-[24px] font-semibold text-foreground">No favorites yet</h2>
