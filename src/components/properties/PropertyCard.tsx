...
export default function PropertyCard({ property }: Props) {
  ...
  return (
    <div
      className="bg-surface border border-border rounded-3xl shadow-sm transition cursor-pointer hover:shadow-md"
      onClick={() => {
      ...
      <div className="p-6 lg:p-8">
        ...
        <span className="text-muted-foreground text-[14px] leading-5">
          {property.city}
        </span>
      </div>
